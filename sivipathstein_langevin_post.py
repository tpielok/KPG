...
class SIVIPathsteinLangevin(object):
    ...
    def learn(self):
        ...
        for epoch in tqdm(range(1, self.trainpara.num_epochs+1)):
            ...
            for i in range(1, self.trainpara.num_perepoch+1):
                ...
                loss_kxy = (self.kernel(X.detach(), X_aux).matmul(-neg_score_implicit_aux -  compu_targetscore_aux.detach()) * X).sum(dim=1).mean()
...
if __name__ == "__main__":
    ...
    task = SIVIPathsteinLangevin(config)
    task.learn()
